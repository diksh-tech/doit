...
TOOLS = {
    "casual_query":{
        "args": [],
        "desc": "just answer the casual query",
    },
    "get_flight_basic_info": {
        "args": ["carrier", "flight_number", "date_of_origin","startStation","endStation"],
        "desc": "Fetch basic flight information including carrier, flight number, stations, scheduled times, flight status, isOTPachieved, OTP.",
    },
    "get_equipment_info": {
    ...
    "get_passenger_info": {
        "args": ["carrier", "flight_number", "date_of_origin"],
        "desc": "Get passenger information including passenger count code.",
    },
    "get_operation_times": {
        "args": ["carrier", "flight_number", "date_of_origin"],
